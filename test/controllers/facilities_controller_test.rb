...
class FacilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create facility" do
    assert_difference("Facility.count") do
      post facilities_url, params: { facility: { description: @facility.description, location: @facility.location, name: @facility.name, pincode: @facility.pincode, sport: @facility.sport } }
    end
  ...
  test "should update facility" do
    patch facility_url(@facility), params: { facility: { description: @facility.description, location: @facility.location, name: @facility.name, pincode: @facility.pincode, sport: @facility.sport } }
